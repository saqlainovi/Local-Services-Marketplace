...
$id = $_GET['id'];
$query = "SELECT * FROM battery_services WHERE id = ?";
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-4">
            <img src="<?php echo isset($provider['image']) ? $provider['image'] : 'cropped-images (1)/battery-1.jpg'; ?>" 
        ...
        <div class="col-md-8">
            ...
            <div class="mb-2">
                <i class="fa fa-money text-success"></i> ৳<?php echo htmlspecialchars($provider['price_per_service']); ?> per service
            </div>
            <div class="mb-2">
                <i class="fa fa-battery-full text-info"></i> <?php echo htmlspecialchars($provider['battery_types']); ?>
            </div>
            <div class="mb-2">
            ...
            <?php if($provider['availability']): ?>
                <a href="payment.php?type=battery&id=<?php echo $provider['id']; ?>" class="btn btn-primary mt-3">
                    <i class="fas fa-tools"></i> Hire Now
                </a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="mt-4 mb-5">
        ...
        <form action="process_review.php" method="POST">
            <input type="hidden" name="battery_service_id" value="<?php echo $id; ?>">
            <div class="mb-3">
