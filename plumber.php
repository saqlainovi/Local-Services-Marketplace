...
$service_images = [
    ...
    'cropped-images (1)/plumbing-1.jpg',
    'cropped-images (1)/plumbing-2.jpg',
    'cropped-images (1)/plumbing-3.jpg'
];
?>

<div class="container mt-4">
    <h2 class="text-center mb-4">Available Plumbers</h2>
            ...
            <form method="GET" class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="location" class="form-select">
                        ...
                        <?php
                        $locations = mysqli_query($con, "SELECT DISTINCT location FROM plumbers");
    ...
    <div class="row">
        ...
        $query = "SELECT * FROM plumbers WHERE 1=1";
        $params = [];
        $types = "";
        ...
        if(mysqli_num_rows($result) == 0) {
            echo '<div class="col-12"><div class="alert alert-info">No plumbers found matching your criteria.</div></div>';
        }
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?= isset($row['image']) ? $row['image'] : 'assets/img/default-plumber.jpg' ?>" 
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="plumber_info.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
