            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?php echo isset($row['image']) ? $row['image'] : 'assets/img/default-plumber.jpg'; ?>" 
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="plumber_info.php?id=<?php echo $row['id']; ?>" 
                                           class="btn btn-outline-primary me-2">View Details</a>
                                        <?php if(isset($_SESSION['auth_user'])): ?>
                                            <?php if($row['availability']): ?>
                                                <a href="payment.php?id=<?php echo $row['id']; ?>&type=plumber" 
