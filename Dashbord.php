            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="edit_profile.php" class="list-group-item list-group-item-action">Change Profile</a>
                        <a href="reviews.php" class="list-group-item list-group-item-action">Reviews & Ratings</a>
                    </div>
                </div>
            </div>
        </div>
